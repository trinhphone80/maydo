...
export const getHealthAdvice = async (userPrompt: string) => {
  ...
  if (!apiKey || apiKey === "undefined") {
    return "Dạ, Đức Phương xin chào bác ạ. Hiện tại trợ lý AI đang bận một chút, bác vui lòng để lại số điện thoại trong form đăng ký hoặc gọi hotline 0903.162.808 để em hỗ trợ bác ngay nhé!";
  }
  ...
  try {
    ...
    return "Dạ, Đức Phương xin chào bác. Do số lượng bác đăng ký quá đông nên hệ thống đang phản hồi chậm. Bác vui lòng điền thông tin vào form bên dưới, bên em sẽ gọi lại hỗ trợ bác ngay lập tức ạ!";
  }
};
